...
\begin{lstlisting}[style=golang, caption={Custom blockchain transaction types}, label={lst:blockchain_types}]
type TransactionType string

const (
    TxAddVoter TransactionType = "ADD_VOTER"
    TxRegister TransactionType = "REGISTER"
...
type Block struct {
    ...
    Transactions []Transaction // Election operations
