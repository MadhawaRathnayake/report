...
\begin{enumerate}
    \item Design and implementation of ZK circuits using Noir language to prove voter eligibility.
    \item Creation of a custom blockchain in Go using specific blockchain transaction types and state machine for elections.
    ...
    \item Implementation of anonymous vote casting (cryptographic identity separation)
    \item Unit testing and integration of the entire system
    \item Demonstration of end-to-end verifiability
\end{enumerate}

\textbf{Limitations and Exclusions:}
\begin{enumerate}
    \item It is currently running on the local Hardhat (Ethereum) blockchain for fast development and migration is underway to the custom Go blockchain.
    \item Voter authentication by address-based allowlisting.
    \item The system targets at web browsers that support WebAssembly technology
